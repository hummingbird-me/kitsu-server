  ...
  describe '#to_xml' do
    ...
    context 'for an Anime' do
      ...
      context 'on planned list' do
        ...
        it 'has a my_status node with "Plan to Watch"' do
      ...
      context 'on current list' do
        ...
        it 'has a my_status node with "Watching"' do
    ...
    context 'with a started_at time' do
      ...
      it 'has a my_start_date node in YYYY-MM-DD format' do
    ...
    context 'with a finished_at time' do
      ...
      it 'has a my_finish_date node in YYYY-MM-DD format' do
    ...
    context 'with a rating' do
      ...
      it 'has a my_score node with half the Kitsu rating' do
    ...
    context 'with comments and notes' do
      ...
      it 'has comments and tags parsed from notes' do
