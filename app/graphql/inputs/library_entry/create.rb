class Inputs::LibraryEntry::Create < Inputs::BaseInputObject
  argument :user_id, ID, required: true
  argument :media_id, ID, required: true
  argument :media_type, Types::MediaType, required: true
  argument :status, Types::LibraryEntryStatus, required: true
