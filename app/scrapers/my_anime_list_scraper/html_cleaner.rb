class MyAnimeListScraper
  ...
  class HtmlCleaner
    ...
    # Extract the freeform colon-separated data that prefaces some synopsis/description sections on
    # MAL into a Hash<String,String> where the values are HTML fragments.  Also removes the nodes it
    # extracts in the proceess.
    #
    # @param doc [Nokogiri::Document] the document or fragment to clean the info in
    # @return [Hash<String,String>] the list of keys and their HTML fragment values
    ...
    # Builds a <data><dl></dl></data> structure for a hash of information
    #
    # @param info [Hash<String,String>] the list of keys and their HTML values
    # @return [Nokogiri::Document] the document fragment generated by this
    def build_info_dictionary(info)
