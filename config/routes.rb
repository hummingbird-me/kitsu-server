...
# == Route Map
#
# I, [2017-06-13T02:20:26.736669 #69135]  INFO -- : Raven 2.4.0 configured not to capture errors: DSN not set
...
#        user_relationships_notification_settings GET       /api/edge/users/:user_id/relationships/notification-settings(.:format)                    users#show_relationship {:relationship=>"notification_settings"}
#                                                 POST      /api/edge/users/:user_id/relationships/notification-settings(.:format)                    users#create_relationship {:relationship=>"notification_settings"}
#                                                 PUT|PATCH /api/edge/users/:user_id/relationships/notification-settings(.:format)                    users#update_relationship {:relationship=>"notification_settings"}
#                                                 DELETE    /api/edge/users/:user_id/relationships/notification-settings(.:format)                    users#destroy_relationship {:relationship=>"notification_settings"}
#                      user_notification_settings GET       /api/edge/users/:user_id/notification-settings(.:format)                                  notification_settings#get_related_resources {:relationship=>"notification_settings", :source=>"users"}
...
#         notification_setting_relationships_user GET       /api/edge/notification-settings/:notification_setting_id/relationships/user(.:format)     notification_settings#show_relationship {:relationship=>"user"}
#                                                 PUT|PATCH /api/edge/notification-settings/:notification_setting_id/relationships/user(.:format)     notification_settings#update_relationship {:relationship=>"user"}
#                                                 DELETE    /api/edge/notification-settings/:notification_setting_id/relationships/user(.:format)     notification_settings#destroy_relationship {:relationship=>"user"}
#                       notification_setting_user GET       /api/edge/notification-settings/:notification_setting_id/user(.:format)                   users#get_related_resource {:relationship=>"user", :source=>"notification_settings"}
#                           notification_settings GET       /api/edge/notification-settings(.:format)                                                 notification_settings#index
#                                                 POST      /api/edge/notification-settings(.:format)                                                 notification_settings#create
#                            notification_setting GET       /api/edge/notification-settings/:id(.:format)                                             notification_settings#show
#                                                 PATCH     /api/edge/notification-settings/:id(.:format)                                             notification_settings#update
#                                                 PUT       /api/edge/notification-settings/:id(.:format)                                             notification_settings#update
#                                                 DELETE    /api/edge/notification-settings/:id(.:format)                                             notification_settings#destroy
