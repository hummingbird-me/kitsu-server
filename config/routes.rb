...
Rails.application.routes.draw do
  scope '/api' do
    scope '/edge' do
      ...
      jsonapi_resources :user_settings
...
# == Route Map
#
# I, [2017-04-12T07:12:16.330113 #8]  INFO -- : Raven 2.4.0 configured not to capture errors: DSN not set
...
#                 user_setting_relationships_user GET       /api/edge/user-settings/:user_setting_id/relationships/user(.:format)                     user_settings#show_relationship {:relationship=>"user"}
#                                                 PUT|PATCH /api/edge/user-settings/:user_setting_id/relationships/user(.:format)                     user_settings#update_relationship {:relationship=>"user"}
#                                                 DELETE    /api/edge/user-settings/:user_setting_id/relationships/user(.:format)                     user_settings#destroy_relationship {:relationship=>"user"}
#                               user_setting_user GET       /api/edge/user-settings/:user_setting_id/user(.:format)                                   users#get_related_resource {:relationship=>"user", :source=>"user_settings"}
#                                   user_settings GET       /api/edge/user-settings(.:format)                                                         user_settings#index
#                                                 POST      /api/edge/user-settings(.:format)                                                         user_settings#create
#                                    user_setting GET       /api/edge/user-settings/:id(.:format)                                                     user_settings#show
#                                                 PATCH     /api/edge/user-settings/:id(.:format)                                                     user_settings#update
#                                                 PUT       /api/edge/user-settings/:id(.:format)                                                     user_settings#update
#                                                 DELETE    /api/edge/user-settings/:id(.:format)                                                     user_settings#destroy
