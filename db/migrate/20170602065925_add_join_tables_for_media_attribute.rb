class AddJoinTablesForMediaAttribute < ActiveRecord::Migration
  def change
      ...
      t.references :anime, null: false, index: true, foreign_key: true, required: true
      ActiveRecord::Base.pluralize_table_names = false
      t.references :media_attribute, null: false, index: true, foreign_key: true, required: true
    ...
    create_table :dramas_media_attributes do |t|
      t.references :drama, null: false, index: true, foreign_key: true, required: true
      ActiveRecord::Base.pluralize_table_names = false
      t.references :media_attribute, null: false, index: true, foreign_key: true, required: true
      ActiveRecord::Base.pluralize_table_names = true
      t.integer :high_vote_count, default: 0, null: false
    ...
    create_table :manga_media_attributes do |t|
      t.references :manga, null: false, index: true, foreign_key: true, required: true
      ActiveRecord::Base.pluralize_table_names = false
      t.references :media_attribute, null: false, index: true, foreign_key: true, required: true
      ActiveRecord::Base.pluralize_table_names = true
      t.integer :high_vote_count, default: 0, null: false
